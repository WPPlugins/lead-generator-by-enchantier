...
class EnChantier {
    ...
    public function menu_home() {
        ...
        get_currentuserinfo();
        $urls = array(
            __('Activité / Facturation') => 'http://www.enchantier.com/module_partenaire/?api_key=' . ENCHANTIER_KEY . '&hash=' . ENCHANTIER_PASSWORD . '&name=' . $current_user->display_name
        );
            ...
            jQuery(function ($) {
                ...
                $(window).unload(function () {
                    $.ajax({
                        ...
                        jsonp: false,
                        type: "GET",
                        url: "http://www.enchantier.com/module_partenaire/index.php",
                        async: false,
                        data: "c=3",
